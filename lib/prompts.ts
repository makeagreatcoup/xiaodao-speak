...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: "心理学",
    tag: "认知偏误",
    blurb: "认知偏误、启发式、系统1与系统2——先把人脑的坑查明白，再开口。",
  },
  {
    key: "economics",
    name: "经济学",
    tag: "理性选择",
    blurb: "机会成本、博弈论、行为经济学、心理账户——用稀缺与激励的透镜看世界。",
  },
  {
    key: "sociology",
    name: "社会学",
  ...
  },
  {
    ...
    name: "逻辑与数学",
    tag: "思维体操",
    blurb: "芝诺悖论、蒙提霍尔、辛普森悖论、贝叶斯——在严密与反直觉之间练脑子。",
  },
...
// ===== 个人词库 =====
// 个人词库的每个词可带一个领域标签（哲学 / 心理学 / 经济学 / 社会学 / 逻辑与数学 / 自命题），
