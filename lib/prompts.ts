...
// 全部是真实框架，话题均取自各框架的完整概念集：
//  · 哲学 / 心理学 / 经济学 / 社会学 / 逻辑与数学 —— 各学科标准概念与议题
//  · 认知偏误 —— 中文维基《认知偏误列表》完整清单（决策/社会偏误）
//  · 博弈论 / 行为经济学 / 统计与概率悖论 / 启发式 —— 各领域的完整真实概念集
export const categories: Category[] = [
...

  {
    ...
    name: "认知偏误",
    tag: "烧脑坑",
    blurb: "锚定、确认偏误、幸存者偏差、达克效应——人脑的坑，查明白再开口。",
  },
  {
    key: "game-theory",
    name: "博弈论",
    tag: "策略互动",
    blurb: "囚徒困境、谢林点、以牙还牙、公地悲剧——把策略与博弈讲清楚。",
  },
  {
    key: "behavioral-econ",
    name: "行为经济学",
    tag: "非理性",
    blurb: "前景理论、心理账户、损失厌恶、选择的悖论——人在金钱与选择里的不理性。",
  },
  {
    key: "stats-paradox",
    name: "统计与概率悖论",
    tag: "反直觉",
    blurb: "辛普森悖论、蒙提霍尔、假阳性悖论——数据会骗人，讲清为什么。",
  },
  {
    key: "heuristics",
    name: "启发式",
    tag: "思维捷径",
    blurb: "可得性、代表性、林迪效应、系统1与系统2——大脑走捷径的方式。",
  },
...
// ===== 个人词库 =====
// 个人词库的每个词可带一个领域标签（哲学 / 心理学 / 经济学 / 社会学 / 逻辑与数学 / 认知偏误 / 博弈论 / 行为经济学 / 统计与概率悖论 / 启发式 / 自命题），
